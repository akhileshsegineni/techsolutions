    ...
    if (activeOrders.length === 0) {
        ...
        for (var i = 0; i < activeOrders.length; i++) {
            ...
            activeList.innerHTML +=
                ...
                '<a href="javascript:void(0)" onclick="viewProjectFiles(\'' + o.id + '\')" style="color: var(--accent); font-size: 13px; font-weight: 600; text-decoration: none;">View Project Files</a>' +
...
function contactManager(id) {
    ...
    if (details) {
        details.innerHTML = 
            '<div style="width: 80px; height: 80px; background: var(--accent-light); border-radius: 50%; margin: 0 auto 15px; display: flex; align-items: center; justify-content: center; font-size: 30px;">👨‍💼</div>' +
            '<h3 style="color: var(--text-main); margin-bottom: 5px;">Suresh Khanna</h3>' +
            '<p style="color: var(--text-muted); font-size: 14px; margin-bottom: 15px;">Senior Project Lead</p>' +
            '<p style="color: var(--text-light); font-size: 14px;">Email: suresh.k@techsolutions.com</p>' +
